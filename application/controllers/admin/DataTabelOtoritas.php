...
class DataTabelOtoritas extends CI_Controller{
    ...
    public function index()
    {
        ...
        $data['checklist'] = $this->lkeModel->get_data('checklist')
            ->result();
        $this->load->view('admin/tabelOtoritas',$data);
    }
    ...
    public function updateData($id)
    {
        ...
        $data['checklist'] = $this->db->query("Select * FROM checklist WHERE
            no = '$id'")->result();
        $this->load->view('admin/formUpdateOtoritas',$data);
    }
    ...
    public function updateDataAksi()
    {
        ...
        if($this->form_validation->run() == FALSE){
            ...
            redirect('admin/dataTabelOtoritas');
        }
    }

    public function tambahData()
    {   
        $this->load->view('admin/formTambahOtoritas');
    }
