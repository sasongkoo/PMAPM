    ...
    <main>
        <div class="container-fluid">
            ...
            <div class="container px-4">
                ...
                <a class="btn btn-success mb-3 float-right" href="<?php echo base_url('admin/dataTabel/tambahData/') ?>"><i class="fa-solid fa-file-circle-plus fa-beat"></i> Tambah Data</a>
            ...
            <div class="container px-4">
                ...
                <table id="example" class="table table-bordered rounded-3 table-striped bg-success p-2 text-dark bg-opacity-25 mt-4 display nowrap" style="width:100% ;">
                    <thead>
                        <tr>
                    ...
                    <tbody class="table-group-divider">
                        ...
                        foreach ($checklist as $c) : ?>
                            <tr>
                                <td>
                                    <center>
                                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/dataTabel/updateData/' . $c->no) ?>">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a onclick="return confirm('Yakin Hapus')" class="btn btn-sm btn-danger" href="<?php echo base_url('admin/dataTabel/deleteData/' . $c->no) ?>">
                                ...
                                <td style="width: 20%;"><?php echo $c->area ?></td>
                                <td style="width: 20%;"><?php echo $c->penilaian ?></td>
